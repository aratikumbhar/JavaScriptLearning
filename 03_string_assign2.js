...
console.log(
  ...
  sentenceLen.charAt(0),
  "and the last character of string is: ",
  sentenceLen.charAt(32)
);
console.log(
  "                                                                              "
);
...
console.log(
  ...
  sentenceLen.substring(22)
);
console.log(
  "     ",
  "Substring starting from index 22 is : ",
  sentenceLen.slice(22, 32)
);
console.log(
  "                                                                              "
);

console.log("9)   ", `Is string ending with "up" : `, sentenceLen.endsWith());
console.log(
  "                                                                              "
);
...
console.log(
  "10)   ",
  `Is string starting with "Hey" : `,
  sentenceLen.startsWith("Hey")
);
